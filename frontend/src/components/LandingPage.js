      ...
      <div className="landing-content">
        ...
        <section ref={featuresRef} className="landing-section">
          <div className="landing-container">
            ...
            {/* Desktop: Nightwatch-style Feature Panels (1×6) */}
            <div className="feature-panels--desktop hidden lg:block">
              {/* Feature Pane 1 */}
              <article className="feature-pane group">
                <div className="pane-meta">
                  <div className="icon-chip">
                    <Code className="h-5 w-5" aria-hidden="true" />
                  </div>
                  <h3 className="pane-headline">Generate AI Python strategies</h3>
                  <p className="pane-description">
                    Describe your idea and get production-ready Python code, complete with indicators, entry/exit rules, and risk controls.
                  </p>
                </div>
                <div className="pane-shot" role="img" aria-label="Strategy Builder Interface Screenshot">
                  <div className="screenshot-placeholder">
                    <span className="screenshot-text">Product Screenshot</span>
                  </div>
                </div>
                <div className="pane-caption">
                  <h4 className="caption-title">Strategy Builder Interface</h4>
                  <p className="caption-text">Prompt-to-code editor with indicator library, entry/exit blocks, and risk controls ready for export.</p>
                </div>
              </article>
              ...
              <article className="feature-pane group">
                <div className="pane-meta">
                  ...
                  <h3 className="pane-headline">Backtest with confidence</h3>
                  <p className="pane-description">
                ...
                <div className="pane-shot" role="img" aria-label="Backtest Results Overview Screenshot">
                  <div className="screenshot-placeholder">
                    <span className="screenshot-text">Product Screenshot</span>
                  </div>
                </div>
                <div className="pane-caption">
                  <h4 className="caption-title">Backtest Results Overview</h4>
                  <p className="caption-text">Equity curve with trade markers, quartile trade curves, and metrics (P&L, Win%, Sharpe, Drawdown).</p>
                </div>
              </article>
              ...
              <article className="feature-pane group">
                <div className="pane-meta">
                  ...
                  <h3 className="pane-headline">Go live in one click</h3>
                  <p className="pane-description">
                ...
                <div className="pane-shot" role="img" aria-label="Live Trading Control Center Screenshot">
                  <div className="screenshot-placeholder">
                    <span className="screenshot-text">Product Screenshot</span>
                  </div>
                </div>
                <div className="pane-caption">
                  <h4 className="caption-title">Live Trading Control Center</h4>
                  <p className="caption-text">Broker connection status, routing, position sizing, start/stop checks, and live order log.</p>
                </div>
              </article>
              ...
              <article className="feature-pane group">
                <div className="pane-meta">
                  ...
                  <h3 className="pane-headline">Multiple brokers and multiple accounts at once</h3>
                  <p className="pane-description">
                    Choose what strategy is filled on which account in which broker, separate or aggregate a portfolio of strategies.
                  </p>
                </div>
                <div className="pane-shot" role="img" aria-label="Account & Allocation Matrix Screenshot">
                  <div className="screenshot-placeholder">
                    <span className="screenshot-text">Product Screenshot</span>
                  </div>
                </div>
                <div className="pane-caption">
                  <h4 className="caption-title">Account & Allocation Matrix</h4>
                  <p className="caption-text">Map strategies to brokers/accounts, set allocation %, and toggle fills per venue.</p>
                </div>
              </article>
              ...
              <article className="feature-pane group">
                <div className="pane-meta">
                  ...
                  <h3 className="pane-headline">Sync & review discretionary trades</h3>
                  <p className="pane-description">
                    Real-time dashboards, alerts, and a structured trade journal to track P&L, drawdown, win rate, and expectancy.
                  </p>
                </div>
                <div className="pane-shot" role="img" aria-label="Trade Journal Analytics Screenshot">
                  <div className="screenshot-placeholder">
                    <span className="screenshot-text">Product Screenshot</span>
                  </div>
                </div>
                <div className="pane-caption">
                  <h4 className="caption-title">Trade Journal Analytics</h4>
                  <p className="caption-text">Synced fills with tags and filters, performance heatmap, and setup-level insights.</p>
                </div>
              </article>
              ...
              <article className="feature-pane group">
                <div className="pane-meta">
                  ...
                  <h3 className="pane-headline">Integrate Strategies with Live News</h3>
                  <p className="pane-description">
                ...
                <div className="pane-shot" role="img" aria-label="News Signal Linkage Screenshot">
                  <div className="screenshot-placeholder">
                    <span className="screenshot-text">Product Screenshot</span>
                  </div>
                </div>
                <div className="pane-caption">
                  <h4 className="caption-title">News Signal Linkage</h4>
                  <p className="caption-text">Real-time feed with tickers & sentiment; strategy triggers linked to news events.</p>
                </div>
              </article>
            </div>

            {/* Mobile: Original 2×3 Grid (unchanged) */}
            <div className="feature-grid-six lg:hidden">
              {/* Card 1 */}
              ...
              <div className="landing-card pricing-card">
                <div className="landing-card-content">
                  ...
                  <ul className="feature-list">
                    ...
                    <li className="feature-item">
                      <CheckCircle className="feature-icon" />
                      <span>AI Assistant (50 monthly credits)</span>
                    </li>
                    <li className="feature-item">
                      <CheckCircle className="feature-icon" />
              ...
              <div className="landing-card pricing-card">
                <div className="landing-card-content">
                  ...
                  <ul className="feature-list">
                    ...
                    <li className="feature-item">
                      <CheckCircle className="feature-icon" />
                      <span>AI Assistant (100 monthly credits)</span>
                    </li>
                    <li className="feature-item">
                      <CheckCircle className="feature-icon" />
                      <span>Backtesting</span>
